...
const BurgerIngredientGroup = React.forwardRef<
  HTMLHeadingElement,
  TBurgerIngredientGroupProps
>((props, ref) => {
  ...
  return (
    <div className={styles.cards}>
      <h3
        className={classNames(styles.card__title, `text text_type_main-medium`)}
        id={props.titleId}
        ref={ref}
      >
        {props.title}
